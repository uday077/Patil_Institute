      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
        ...
        <div className="glass" style={{ padding: '2.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ fontSize: '1.75rem', color: 'white' }}>{t.guidance.whatIsIT.title}</h3>
          </div>
        ...
        <div className="glass" style={{ padding: '2.5rem', borderLeft: '4px solid #10b981' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
            ...
            <h3 style={{ fontSize: '1.75rem', color: 'white' }}>{t.guidance.basics.title}</h3>
          </div>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            ...
            <h3 style={{ fontSize: '2rem', color: 'white' }}>{t.guidance.pathways.title}</h3>
          </div>
          <div className="grid">
            <div className="card glass">
              <GraduationCap size={32} color="#f59e0b" style={{ marginBottom: '1rem' }} />
              <h4 style={{ fontSize: '1.25rem', color: 'white', marginBottom: '1rem' }}>{t.guidance.pathways.after10th.title}</h4>
              <p style={{ color: 'var(--text-muted)' }}>{t.guidance.pathways.after10th.desc}</p>
            </div>
            <div className="card glass">
              <GraduationCap size={32} color="#f59e0b" style={{ marginBottom: '1rem' }} />
              <h4 style={{ fontSize: '1.25rem', color: 'white', marginBottom: '1rem' }}>{t.guidance.pathways.after12th.title}</h4>
              <p style={{ color: 'var(--text-muted)' }}>{t.guidance.pathways.after12th.desc}</p>
            </div>
            <div className="card glass">
              <GraduationCap size={32} color="#f59e0b" style={{ marginBottom: '1rem' }} />
              <h4 style={{ fontSize: '1.25rem', color: 'white', marginBottom: '1rem' }}>{t.guidance.pathways.afterGrad.title}</h4>
        ...
        <div style={{ marginTop: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            ...
            <h3 style={{ fontSize: '2rem', color: 'white' }}>{t.guidance.profilesTitle}</h3>
          </div>
          <div className="grid">
